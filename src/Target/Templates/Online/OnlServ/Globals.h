/* $Header: /4CReleased/V2.20.00/Target/TEMPLATES/Online/OnlServ/Globals.h 1     28.02.07 18:54 Ln $
 * ------------------------------------------------------------------------------
 *
 * =FILENAME			$Workfile: Globals.h $
 *						 $Logfile: /4CReleased/V2.20.00/Target/TEMPLATES/Online/OnlServ/Globals.h $
 *
...
DEFINE const TCHAR g_csApp[]					INIT_WITH(_T("OnlServ[*PR]"));
DEFINE const TCHAR g_APP_ID[]					INIT_WITH(_T("{cc473905-0371-4868-ba16-44190dbcd8bf}"));
DEFINE const TCHAR g_ProgID_OPCServer[]			INIT_WITH(_T("4C_20_[*TN].Online_Server."));
DEFINE const TCHAR g_ProgID_ControlMgt[]		INIT_WITH(_T("4C_20_[*TN].ControlMgt."));
DEFINE const TCHAR g_ProgID_CommissioningMgt[]	INIT_WITH(_T("4C_20_[*TN].CommissioningMgt."));

DEFINE const TCHAR g_csRemoteLicEnabled[]		INIT_WITH(_T("RemoteLic"));
DEFINE BOOL  g_bSupportDebugDownload			INIT_WITH([*DD]);
