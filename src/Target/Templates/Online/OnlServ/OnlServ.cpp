/* $Header: /4CReleased/V2.20.00/Target/TEMPLATES/Online/OnlServ/OnlServ.cpp 1     28.02.07 18:54 Ln $
 * ------------------------------------------------------------------------------
 *
 * =FILENAME			$Workfile: OnlServ.cpp $
 *						 $Logfile: /4CReleased/V2.20.00/Target/TEMPLATES/Online/OnlServ/OnlServ.cpp $
 *
...
#define OPC_SERV_BIG_ENDIAN [*ENDIAN]
