/* $Header: /4CReleased/V2.20.00/Target/TEMPLATES/inc/intOpcds.h 1     28.02.07 18:54 Ln $
 * ------------------------------------------------------------------------------
 *
 * =FILENAME			$Workfile: intOpcds.h $
 *						 $Logfile: /4CReleased/V2.20.00/Target/TEMPLATES/inc/intOpcds.h $
 *
