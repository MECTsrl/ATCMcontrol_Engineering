...
DEFINE const TCHAR g_csApp[]					INIT_WITH(_T("OnlServATHW119"));
DEFINE const TCHAR g_APP_ID[]					INIT_WITH(_T("{cc473905-0371-4868-ba16-44190dbcd8bf}"));
DEFINE const TCHAR g_ProgID_OPCServer[]			INIT_WITH(_T("4C_20_HW119.Online_Server."));
DEFINE const TCHAR g_ProgID_ControlMgt[]		INIT_WITH(_T("4C_20_HW119.ControlMgt."));
DEFINE const TCHAR g_ProgID_CommissioningMgt[]	INIT_WITH(_T("4C_20_HW119.CommissioningMgt."));
