/* $Header: /4CReleased/V2.20.00/Target/4CWin/CONTROL/ioTest/tstMain.c 1     28.02.07 19:10 Ln $
 * ------------------------------------------------------------------------------
 *
 * =FILENAME			$Workfile: tstMain.c $
 *						 $Logfile: /4CReleased/V2.20.00/Target/4CWin/CONTROL/ioTest/tstMain.c $
 *
