/* $Header: /4CReleased/V2.20.00/Target/4CWin/CONTROL/ioTest/tstImpl.c 1     28.02.07 19:10 Ln $
 * ------------------------------------------------------------------------------
 *
 * =FILENAME			$Workfile: tstImpl.c $
 *						 $Logfile: /4CReleased/V2.20.00/Target/4CWin/CONTROL/ioTest/tstImpl.c $
 *
