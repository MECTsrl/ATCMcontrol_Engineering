/* $Header: /4CReleased/V2.20.00/Target/4CWin/Control/inc/osDef.h 4     24.02.08 18:13 Ln $
 * ------------------------------------------------------------------------------
 *
 * =FILENAME			$Workfile: osDef.h $
 *						 $Logfile: /4CReleased/V2.20.00/Target/4CWin/Control/inc/osDef.h $
 *
...
#define RTS_CFG_WINDOWS
#undef	RTS_CFG_LINUX
#define RTS_CFG_SOFTING
...
#define RTS_CFG_LICENSE

#ifndef _USE_EXTERN_
#define RTS_CFG_BACNET
#else
#undef	RTS_CFG_BACNET
#endif
#undef	RTS_CFG_PROFI_DP
#define RTS_CFG_IOTEST
...
#define MAX_DATA_OBJ		6000u	/* Max. number of data objects			*/
...
#define MAX_IO_LAYER		   3u	/* Max. no. of IO layer 				*/
 ...
 * ----------------------------------------------------------------------------
 */
#define VMM_RET_UPD_FIRST		500u
#define VMM_RET_UPD_CYCLE		250u
 ...
 */
#define VMM_SLEEP_OFFSET		0u


/* VM First Execution Delay
 * ----------------------------------------------------------------------------
 */
#define VM_FIRST_EXEC_DELAY 	500u
...
#define WD_MAX_PENDING_INACTIVE		25
...
#define DEC_PTR(type, var)		type OS_LPTR * var
...
#define OS_ATOMIC	unsigned int			/* Atomic integer data type */
...
#define IEC_LINT	__int64 				/* 64 bit signed (NS)		*/
...
#define IEC_ULINT	unsigned __int64		/* 64 bit unsigned (NS) 	*/
...
#define IEC_DWORD	unsigned long			/* 32 bit signed			*/
...
#define IP_CFG_USINT		/* IP supports USINT  */	/* not supported */
#define IP_CFG_UINT 		/* IP supports UINT   */	/* not supported */
#define IP_CFG_UDINT		/* IP supports UDINT  */	/* not supported */
...
#define IP_CFG_DATE 		/* IP supports DATE   */	/* not supported */
#define IP_CFG_TOD			/* IP supports TOD	  */	/* not supported */
#define IP_CFG_DT			/* IP supports DT	  */	/* not supported */
...
#define OS_STRNICMP 			utilStrnicmp
#define OS_STRICMP				utilStricmp
...
#define IP_WORD(dst)		*((IEC_WORD  *)&dst) = *((IEC_WORD	OS_CPTR *)pIP); pIP += 2;
#define IP_DWORD(dst)		*((IEC_DWORD *)&dst) = *((IEC_DWORD OS_CPTR *)pIP); pIP += 4;
#define IP_LWORD(dst)		*((IEC_LWORD *)&dst) = *((IEC_LWORD OS_CPTR *)pIP); pIP += 8;
