/* $Header: /4CReleased/V2.20.00/Target/4CWin/CONTROL/inc/iolDef.h 1     28.02.07 19:10 Ln $
 * ------------------------------------------------------------------------------
 *
 * =FILENAME			$Workfile: iolDef.h $
 *						 $Logfile: /4CReleased/V2.20.00/Target/4CWin/CONTROL/inc/iolDef.h $
 *
