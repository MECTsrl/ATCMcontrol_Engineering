/* $Header: /4CReleased/V2.20.00/Target/4CWin/Control/inc/vmmMain.h 3     3.08.07 15:01 Ln $
 * ------------------------------------------------------------------------------
 *
 * =FILENAME			$Workfile: vmmMain.h $
 *						 $Logfile: /4CReleased/V2.20.00/Target/4CWin/Control/inc/vmmMain.h $
 *
...
IEC_UINT fileClose(IEC_UDINT hFile, IEC_BOOL bSync);
...
IEC_UINT fileWrite(IEC_UDINT hFile, IEC_DATA *pData, IEC_UINT uLen, IEC_BOOL bSync);
IEC_UINT fileWriteLine(IEC_UDINT hFile, IEC_CHAR *szData, IEC_BOOL bSync);
