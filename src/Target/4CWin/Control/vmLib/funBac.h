/* $Header: /4CReleased/V2.20.00/Target/4CWin/Control/vmLib/funBac.h 2     24.02.08 14:24 Ln $
 * ------------------------------------------------------------------------------
 *
 * =FILENAME			$Workfile: funBac.h $
 *						 $Logfile: /4CReleased/V2.20.00/Target/4CWin/Control/vmLib/funBac.h $
 *
