/* $Header: /4CReleased/V2.20.00/Target/4CWin/CONTROL/vmLib/libFile.h 1     28.02.07 19:10 Ln $
 * ------------------------------------------------------------------------------
 *
 * =FILENAME			$Workfile: libFile.h $
 *						 $Logfile: /4CReleased/V2.20.00/Target/4CWin/CONTROL/vmLib/libFile.h $
 *
