...
//                           OPC TOOLBOX - SOAeS                              |
//                                                                            |
//  Filename    : SOAeSCondition.h                                            |
//  Version     : 3.10.release                                                |
//  Date        : 4-March-2002                                                |
//                                                                            |
//  Description : Condition related classes                                   |
//                 - SOAeSConditionClass: condition class -                   |
//                                  The descrition of a condition             |
//                 - SOAeSConditionClassSingleStateDefault: default single    |
//                                  state condition class                     |
//                 - SOAeSConditionClassMultipleStateDefault: default multiple|
//                                  state condition class                     |
//                 - SOAeSCondition: condition instance -                     |
//                                  A condition connected to a source         |
//                 - SOAeSConditionIAttr: attribte interface of the condition |
//                 - SOAeSConditionAttrFull: full implementation of the       |
//                                  attribte interface of the condition       |
//                 - SOAeSConditionDefault: default implementation of         |
//                                  condition                                 |
//                 - SOAeSConditionGroup: group of conditions                 |
//                                                                            |
//-----------------------------------------------------------------------------
...
{ SOCmnSingleLock<SOCmnSync> objectLock(SOCmnObjectLock::getObjectLock(this)); m_conditionClass.addRef(); return (SOAeSConditionClass *)m_conditionClass; }

inline SOAeSSubConditionClass *SOAeSCondition::getActSubConditionClass(void)
{ SOCmnSingleLock<SOCmnSync> objectLock(SOCmnObjectLock::getObjectLock(this)); m_actSubConditionClass.addRef(); return (SOAeSSubConditionClass *)m_actSubConditionClass; }
