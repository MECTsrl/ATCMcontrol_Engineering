...
//                           OPC TOOLBOX - SOAsS                              |
//                                                                            |
//  Filename    : SOAsSCondition.h                                            |
//  Version     : 3.10.release                                                |
//  Date        : 4-March-2002                                                |
//                                                                            |
//  Description : Condition related classes                                   |
//                - SOAsSCondition: condition instance -                      |
//                                  A condition connected to a source         |
//                - SOAsSConditionDefault: default implementation of condition|
//                - SOAsSConditionGroup: group of conditions                  |
//                                                                            |
//-----------------------------------------------------------------------------
...
{ m_surveyGroup.addRef(); return (SODaSGroup *)m_surveyGroup; }
