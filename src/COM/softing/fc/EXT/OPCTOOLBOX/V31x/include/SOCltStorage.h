...
//                           OPC TOOLBOX - SOClt                              |
//                                                                            |
//  Filename    : SOCltStorage.h                                              |
//  Version     : 3.10.release                                                |
//  Date        : 4-March-2002                                                |
//                                                                            |
//  Description : Storage class                                               |
//                - SOCltStorage: base storage class                          |
//                                                                            |
//-----------------------------------------------------------------------------
...
inline SOCltStorage& SOCltStorage::operator<<(IN int i)
	{ write(&i, sizeof(i)); return *this; } 

inline SOCltStorage& SOCltStorage::operator<<(IN short s)
	{ write(&s, sizeof(s)); return *this; } 
...
inline SOCltStorage& SOCltStorage::operator<<(IN GUID guid)
	{ write(&guid, sizeof(guid)); return *this; } 
