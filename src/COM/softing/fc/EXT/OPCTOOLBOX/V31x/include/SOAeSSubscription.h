...
//                           OPC TOOLBOX - SOAeS                              |
//                                                                            |
//  Filename    : SOAeSSubscription.h                                         |
//  Version     : 3.10.release                                                |
//  Date        : 4-March-2002                                                |
//                                                                            |
//  Description : OPC Subscription object related classes                     |
//                - SOAeSSubscription: OPC AE subscription object             |
//                - SOAeSSubscriptionIFilter: Filter functionality interface  |
//                - SOAeSSubscriptionFilterFull: Full filter functionality    |
//                - SOAeSSubscriptionDefault: default subscription class      | 
//                - SOAeSSubscriptionReturnedAttributes: Attributes returned  |
//                                                       by the subcription   |
//                - SOAeSRefresh: Refresh transaction on the subscription     |
//                                                                            |
//-----------------------------------------------------------------------------
...
{ setObjectState(getObjectState() | SOAeSRefresh::collected); }
...
{ SOCmnSingleLock<SOCmnSync> objectLock(SOCmnObjectLock::getObjectLock(this)); m_refresh.addRef(); return ((SOAeSRefresh *)m_refresh); }

inline void SOAeSSubscription::releaseRefresh(void)
{ SOCmnSync *pObjectLock = SOCmnObjectLock::getObjectLock(this); pObjectLock->lock(); m_refresh.release(); pObjectLock->unlock(); }
