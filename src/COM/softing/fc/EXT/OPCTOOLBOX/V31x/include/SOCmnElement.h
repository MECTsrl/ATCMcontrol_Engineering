...
//                           OPC TOOLBOX - SOCmn                              |
//                                                                            |
//  Filename    : SOCmnElement.h                                              |
//  Version     : 3.10.release                                                |
//  Date        : 4-March-2002                                                |
//                                                                            |
//  Description : Tree element classes                                        |
//                - SOCmnElement: tree element class                          |
//                - SOCmnElementIName: element name interface                 |
//                - SOCmnElementNameString: string name implementation        |
//                - SOCmnElementNameInt: DWORD name implementation            |
//                - SOCmnElementIList: element list interface                 |
//                - SOCmnElementListLeaf: leaf list implementation            |
//                - SOCmnElementListBranch: branch list implementation        |
//                - SOCmnElementListAdditional: additional list implementation|
//                - SOCmnElementListLeafBranch: leaf and branch list          |
//                    implementation                                          |
//                - SOCmnElementListLeafAdditional: leaf and additional list  |
//                    implementation                                          |
//                - SOCmnElementListLeafBranchAdditional: leaf, branch and    |
//                    addtional list implementation                           |
//                                                                            |
//-----------------------------------------------------------------------------
...
public:
	...
	// path splitting
	void reducePath(IN LPCTSTR path, OUT LPCTSTR &first, 
