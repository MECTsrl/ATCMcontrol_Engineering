...
//                           OPC TOOLBOX - SOAeS                              |
//                                                                            |
//  Filename    : SOAeSEvent.h                                                |
//  Version     : 3.10.release                                                |
//  Date        : 4-March-2002                                                |
//                                                                            |
//  Description : Condition related classes                                   |
//                - SOAeSEvent: Event base class                              |
//                - SOAeSEventIAttr: Event attribute interface                |
//                - SOAeSEventAttrSimple: Event attributes for simple events  |
//                - SOAeSEventAttrTracking: Event attributes for              |
//                    tracking-related events                                 |
//                - SOAeSEventAttrCondition: Event attributes for             |
//                    condition-related events                                |
//                - SOAeSEventSimpleDefault: Default class for simple events  |
//                - SOAeSEventTrackingDefault: Default class for              |
//                    tracking-related events                                 |
//                - SOAeSEventConditionDefault: Default class for             |
//                    condition-related events                                |
//                                                                            |
//-----------------------------------------------------------------------------
