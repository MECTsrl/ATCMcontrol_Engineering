...
//                           OPC TOOLBOX - SOCmn                              |
//                                                                            |
//  Filename    : SOCmnObject.h                                               |
//  Version     : 3.10.release                                                |
//  Date        : 4-March-2002                                                |
//                                                                            |
//  Description : Basic object classes                                        |
//                - SOCmnObject: root class for most toolbox objects          |
//                - SOCmnPointer: smart pointer template class for SOCmnObject|
//                                                                            |
//-----------------------------------------------------------------------------
...
#define SOCMNOBJECT_TYPE_NODE               (SOCMNOBJECT_TYPE_BRANCH  | 0x0004)
...
#define SOCMNOBJECT_TYPE_AREA_BROWSER       (SOCMNOBJECT_TYPE_ADDITIONAL_ELEMENT | 0x0008)
#define SOCMNOBJECT_TYPE_EVENT_BROWSER      (SOCMNOBJECT_TYPE_OTHER | 0x0001)
#define SOCMNOBJECT_TYPE_NAMESPACE_BROWSER  (SOCMNOBJECT_TYPE_OTHER | 0x0002)
...
public:
	...
	SOCmnPointer& operator=(IN SOCmnPointer& ptr) 
	{ 
		if (p)
			p->release(); 
		p = ptr.p;
