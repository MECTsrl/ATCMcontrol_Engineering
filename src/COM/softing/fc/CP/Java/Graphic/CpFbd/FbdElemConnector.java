/*H>> $Header: /4CReleased/V2.20.00/COM/softing/fc/CP/Java/Graphic/CpFbd/FbdElemConnector.java 1     28.02.07 19:00 Ln $
 *----------------------------------------------------------------------------*
 *
 * =FILENAME            $Workfile: FbdElemConnector.java $
 *                      $Logfile: /4CReleased/V2.20.00/COM/softing/fc/CP/Java/Graphic/CpFbd/FbdElemConnector.java $
 *
 ...
 * 
 * *****************  Version 1  *****************
 * User: Scd          Date: 19.03.01   Time: 15:24
 * Created in $/4Control/COM/softing/fc/CP/Java/Graphic/CpFbd
 * 
 * *****************  Version 1  *****************
...
public class FbdElemConnector extends FbdElemBase
{
//*****************************************************************************
	public FbdElemConnector(
		 int iXo,                  // origin
		 int iYo, 
		 int iWidth,               // size
		 int iHeight, 
...
//*****************************************************************************		
	{
		...
		// draw left arrow
		drawArrow(g, FgCol, dx, 0, h, true, false);		
