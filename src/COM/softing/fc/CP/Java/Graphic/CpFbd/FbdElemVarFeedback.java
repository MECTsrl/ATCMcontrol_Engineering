/*H>> $Header: /4CReleased/V2.20.00/COM/softing/fc/CP/Java/Graphic/CpFbd/FbdElemVarFeedback.java 1     28.02.07 19:00 Ln $
 *----------------------------------------------------------------------------*
 *
 * =FILENAME            $Workfile: FbdElemVarFeedback.java $
 *                      $Logfile: /4CReleased/V2.20.00/COM/softing/fc/CP/Java/Graphic/CpFbd/FbdElemVarFeedback.java $
 *
 ...
 *----------------------------------------------------------------------------*
 * =MODIFICATIONS
 * $History: FbdElemVarFeedback.java $
 * 
 * *****************  Version 1  *****************
 ...
 * 
 * *****************  Version 1  *****************
 * User: Scd          Date: 19.03.01   Time: 15:32
 * Created in $/4Control/COM/softing/fc/CP/Java/Graphic/CpFbd
 * 
 * *****************  Version 1  *****************
...
public class FbdElemVarFeedback extends FbdElemBase
{
//*****************************************************************************
	public FbdElemVarFeedback(
		 int iXo,                  // origin
		 int iYo, 
		 int iWidth,               // size
		 int iHeight, 
