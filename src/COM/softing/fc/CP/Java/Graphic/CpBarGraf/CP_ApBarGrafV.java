/*H>> $Header: /4CReleased/V2.20.00/COM/softing/fc/CP/Java/Graphic/CpBarGraf/CP_ApBarGrafV.java 1     28.02.07 19:00 Ln $
 *----------------------------------------------------------------------------*
 *
 * =FILENAME            $Workfile: CP_ApBarGrafV.java $
 *                      $Logfile: /4CReleased/V2.20.00/COM/softing/fc/CP/Java/Graphic/CpBarGraf/CP_ApBarGrafV.java $
 *
...
//
//==============================================================================
public class CP_ApBarGrafV extends CP_ApBarGraf
{

	// CP_AnalogMonitor Class Constructor
	//--------------------------------------------------------------------------
	public CP_ApBarGrafV()
	{
		super();
	}
	...
	public void init()
	{
		...
		m_GrPBarGraf = new CP_GrPBarGrafV(m_numBarGrafs,
											m_YMin,
											m_YMax,
											m_YOrigin,
											m_barGraf,
		...
		if ( m_limits )
		{
			...
			m_GrPBarGraf.getLimits().addLimit(1,CP_GrLimitsV.LOWER);
			m_GrPBarGraf.getLimits().addLimit(2,CP_GrLimitsV.LOWER);
			m_GrPBarGraf.getLimits().addLimit(3,CP_GrLimitsV.UPPER);
			m_GrPBarGraf.getLimits().addLimit(4,CP_GrLimitsV.UPPER);
		}
