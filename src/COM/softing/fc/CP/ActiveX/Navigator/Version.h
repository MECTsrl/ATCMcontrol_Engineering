...
#define APP_FILEDESCRIPTION		"ATCMControl " PROD_SHORT_VERSION_STR " - CPNavigator"

// internal name of component (i.e. LIBRARY name of DLLs etc.)
#define APP_INTERNALNAME        "CPNavigator"

// build file name of component
#define APP_ORIGINALFILENAME    "CPNavigator.ocx"
 ...
 * Updated in $/4Control/COM/softing/fc/CP/ActiveX/Navigator
 * 
 *==
 *----------------------------------------------------------------------------*
 */
