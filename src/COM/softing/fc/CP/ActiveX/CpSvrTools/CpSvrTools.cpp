// CpSvrTools.cpp : Implementierung der DLL-Exporte.
...
//
//		Ändern Sie die benutzerspezifische Build-Regel für CpSvrTools.idl durch Hinzufügen
//		folgender Dateien.
//			CpSvrTools_p.c
//			dlldata.c
//		Um eine eigene Proxy/Stub-DLL zu erstellen, 
//		führen Sie nmake -f CpSvrToolsps.mk im Projektverzeichnis aus.
...
BEGIN_OBJECT_MAP(ObjectMap)
	OBJECT_ENTRY(CLSID_CpLayout, CCpLayout)
END_OBJECT_MAP()

class CCpSvrToolsApp : public CWinApp
{
public:
...
CCpSvrToolsApp theApp;

BOOL CCpSvrToolsApp::InitInstance()
{
#ifdef _MERGE_PROXYSTUB
...
int CCpSvrToolsApp::ExitInstance()
{
	_Module.Term();
