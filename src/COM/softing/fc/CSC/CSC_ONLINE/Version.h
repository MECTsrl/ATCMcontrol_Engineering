...
#define APP_FILEDESCRIPTION		"ATCMControl " PROD_SHORT_VERSION_STR " - Online Server"

// internal name of component (i.e. LIBRARY name of DLLs etc.)
#define APP_INTERNALNAME        "CSC_Online"

// build file name of component
#define APP_ORIGINALFILENAME    "CSC_Online.dll"
