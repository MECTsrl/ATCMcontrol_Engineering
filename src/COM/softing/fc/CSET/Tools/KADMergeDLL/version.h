...
#define APP_FILEDESCRIPTION		"ATCMControl " PROD_SHORT_VERSION_STR " - KAD Merge Utility"

// internal name of component (i.e. LIBRARY name of DLLs etc.)
#define APP_INTERNALNAME        "KADmerge"

// build file name of component
#define APP_ORIGINALFILENAME    "KADmerge.DLL"
