...
{
	CPStdOut.AddLine("Remaining"           , "TIME"     , "r"      , 0, 4);
...
<table border="0" width="180" height="70" cellpadding="0" cellspacing="0">
    <tr>
	<td>
	<applet id="IdBg"  width="100%" height="100%" code="CP_ApBarGrafH.class" cabbase="/4C/cpclasses.cab">
