/*H>> $Header: /4CReleased/V2.20.00/COM/softing/fc/CMN/fc_util/ice.cpp 1     28.02.07 19:00 Ln $
 *----------------------------------------------------------------------------*
 *
 * =FILENAME            $Workfile: ice.cpp $
 *                      $Logfile: /4CReleased/V2.20.00/COM/softing/fc/CMN/fc_util/ice.cpp $
 *
...
ice_key_encrypt (
	...
	l = (((unsigned long) ptext[0]) << 24) | (ptext[1] << 16)
						| (ptext[2] << 8) | ptext[3];
	r = (((unsigned long) ptext[4]) << 24) | (ptext[5] << 16)
						| (ptext[6] << 8) | ptext[7];
...
ice_key_decrypt (
	...
	l = (((unsigned long) ctext[0]) << 24) | (ctext[1] << 16)
						| (ctext[2] << 8) | ctext[3];
	r = (((unsigned long) ctext[4]) << 24) | (ctext[5] << 16)
						| (ctext[6] << 8) | ctext[7];
