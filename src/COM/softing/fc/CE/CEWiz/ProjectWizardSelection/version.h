...
#define APP_FILEDESCRIPTION		"ATCMControl " PROD_SHORT_VERSION_STR " - Project Wizard Selection"

// internal name of component (i.e. LIBRARY name of DLLs etc.)
#define APP_INTERNALNAME        "ProjectWizardSelection"

// build file name of component
#define APP_ORIGINALFILENAME    "ProjectWizardSelection.dll"
