...
#define APP_FILEDESCRIPTION		"ATCMControl " PROD_SHORT_VERSION_STR " - Standard Project Wizard"

// internal name of component (i.e. LIBRARY name of DLLs etc.)
#define APP_INTERNALNAME        "StandardProjectWizard"

// build file name of component
#define APP_ORIGINALFILENAME    "StandardProjectWizard.dll"
