...
#define APP_FILEDESCRIPTION		"ATCMControl " PROD_SHORT_VERSION_STR " - Project Manager"

// internal name of component (i.e. LIBRARY name of DLLs etc.)
#define APP_INTERNALNAME        "CEProjMan"

// build file name of component
#define APP_ORIGINALFILENAME    "CEProjMan.dll"
