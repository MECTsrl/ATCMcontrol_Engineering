...
// KadManager.cpp : Implementation of DLL Exports.
...
//
//      Modify the custom build rule for KadManager.idl by adding the following 
//      files to the Outputs.
//          KadManager_p.c
//          dlldata.c
//      To build a separate proxy/stub DLL, 
//      run nmake -f KadManagerps.mk in the project directory.
...
OBJECT_ENTRY(CLSID_KadManagerComObj, CKadManagerComObj)
END_OBJECT_MAP()
...
BOOL WINAPI DllMain(HINSTANCE hInstance, DWORD dwReason, LPVOID lpReserved)
{
    ...
    {
        _Module.Init(ObjectMap, hInstance, &LIBID_KADMANAGERLib);
        DisableThreadLibraryCalls(hInstance);
        INIT_INTEGRITY //init integrity - see cmnintegrity.h
    }
