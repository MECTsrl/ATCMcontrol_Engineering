/* $Header: /4CReleased/V2.20.00/TargetBase/ONLINE/OnlLibServ/Globals.h 1     28.02.07 19:06 Ln $
 * ------------------------------------------------------------------------------
 *
 * =FILENAME			$Workfile: Globals.h $
 *						 $Logfile: /4CReleased/V2.20.00/TargetBase/ONLINE/OnlLibServ/Globals.h $
 *
...
#error Must not be set for the OPC server library
#   define DEFINE
...
//----  Global References:   -------------------------------------------------*
//DEFINE LCID     g_lcid                      INIT_WITH(LOCALE_NEUTRAL);
...
DEFINE const TCHAR g_ProgID_CommissioningMgt[]
                                           INIT_WITH(_T("4C_20_Win.CommissioningMgt."));
