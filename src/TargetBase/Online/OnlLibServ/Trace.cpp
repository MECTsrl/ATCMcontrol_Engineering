/* $Header: /4CReleased/V2.20.00/TargetBase/ONLINE/OnlLibServ/Trace.cpp 1     28.02.07 19:06 Ln $
 * ------------------------------------------------------------------------------
 *
 * =FILENAME			$Workfile: Trace.cpp $
 *						 $Logfile: /4CReleased/V2.20.00/TargetBase/ONLINE/OnlLibServ/Trace.cpp $
 *
