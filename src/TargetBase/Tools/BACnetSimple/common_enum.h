...
typedef enum BACnetReliability
{
	...
	BACnetReliabilityTimeout						= 501,
	BACnetReliabilityNotUpdated						= 502
}BACnetReliability;
...
{
	BACnetStateOfDeviceColdstart,
	BACnetStateOfDeviceWarmstart
}BACnetStateOfDevice;
...
typedef enum callback_type
{
	...
	callback_service_override_delete_objectm,
