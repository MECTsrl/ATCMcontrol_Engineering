/* $Header: /4CReleased/V2.20.00/Target/4CWin/Control/WinVisu/visTest.c 2     25.05.07 13:24 Ln $
 * ------------------------------------------------------------------------------
 *
 * =FILENAME			$Workfile: visTest.c $
 *						 $Logfile: /4CReleased/V2.20.00/Target/4CWin/Control/WinVisu/visTest.c $
 *
...
int main (int argc, char *argv[])
{
	...
	if (argc < 3)
	{
		uRes = visInitialize("172.17.3.139", VIS_PORT_SCAN);
	}
	else
	{
