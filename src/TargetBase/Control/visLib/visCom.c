/* $Header: /4CReleased/V2.20.00/Target/4CWin/Control/visLib/visCom.c 2     3.08.07 15:01 Ln $
 * ------------------------------------------------------------------------------
 *
 * =FILENAME			$Workfile: visCom.c $
 *						 $Logfile: /4CReleased/V2.20.00/Target/4CWin/Control/visLib/visCom.c $
 *
...
IEC_UINT domGetPort(IEC_UINT i)
{
	switch(i)
	{
		// OSAI 13/10/2008 - eliminati target altre ditte, inseriti nuovi target OSAI
		case 0:  return 17264;	/* 4CWin	> 20500 */
		case 1:  return 17272;	/* 4COsai         */  // Series 10
		case 2:  return 17400;	/* 4CXTend        */
		case 3:  return 17273;	/* 4COsaiCE       */  // SyncMotion
		case 4:  return 17274;	/* 4CP20L_TS      */
		case 5:  return 17277;	/* 4CPrima_Logic  */

//		case 0:  return 17275;	/* 4CFC 	> 21000 */
//		case 1:  return 17276;	/* 4CBC 			*/
//		case 2:  return 17280;	/* 4CGA				*/
//		case 3:  return 17264;	/* 4CWin	> 20500 */
//		case 4:  return 17265;	/* 4CVxW			*/
//		case 5:  return 17270;	/* DCU01			*/
//		case 6:  return 17271;	/* CMZ				*/
//		case 7:  return 17273;	/* 4COsaiCE 		*/
//		case 8:  return 17267;	/* 4CDemo			*/
//		case 9:  return 17274;	/* 4CSDK			*/
//		case 10: return 17278;	/* 4CDC 			*/
//		case 11: return 17292;	/* Gekko 			*/
	}
 ...
 * domOpenComm
 *
 * Creates a TCP/IP connection to a remote ATCMControl Run Time System.
 *
 */
 ...
 * domCloseComm
 *
 * Close a open TCP/IP connection to a ATCMControl Run Time System.
 *
 */
 ...
 *
 * Receives a data block from an attached ATCMControl Run Time System.
 *
 */
 ...
 *
 * Sends a data block to an attached ATCMControl Run Time System.
 *
 */
#if defined(RTS_CFG_TCP_NATIVE)
