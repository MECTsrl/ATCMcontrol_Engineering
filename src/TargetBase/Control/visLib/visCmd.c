/* $Header: /4CReleased/V2.20.00/Target/4CWin/CONTROL/visLib/visCmd.c 1     28.02.07 19:10 Ln $
 * ------------------------------------------------------------------------------
 *
 * =FILENAME			$Workfile: visCmd.c $
 *						 $Logfile: /4CReleased/V2.20.00/Target/4CWin/CONTROL/visLib/visCmd.c $
 *
