/* $Header: /4CReleased/V2.20.00/Target/4CWin/Control/visLib/visUtil.c 2     19.04.07 13:16 Ln $
 * ------------------------------------------------------------------------------
 *
 * =FILENAME			$Workfile: visUtil.c $
 *						 $Logfile: /4CReleased/V2.20.00/Target/4CWin/Control/visLib/visUtil.c $
 *
...
IEC_CHAR *visError(IEC_UINT uErrNo)
{
	...
	case ERR_UNKNOWN_PRODUCT	:	szError = "Unknown ATCMControl product ID given";							break;
