/* $Header: /4CReleased/V2.20.00/Target/4CWin/Control/osShared/osLoad.c 2     3.08.07 15:01 Ln $
 * ------------------------------------------------------------------------------
 *
 * =FILENAME			$Workfile: osLoad.c $
 *						 $Logfile: /4CReleased/V2.20.00/Target/4CWin/Control/osShared/osLoad.c $
 *
