/* $Header: /4CReleased/V2.20.00/Target/4CWin/INC/visShared.h 1     28.02.07 19:10 Ln $
 * ------------------------------------------------------------------------------
 *
 * =FILENAME			$Workfile: visShared.h $
 *						 $Logfile: /4CReleased/V2.20.00/Target/4CWin/INC/visShared.h $
 *
 ...
 * ATCMControl Run Time System TCP/IP port numbers.
 */
 ...
 * initialized if it has a valid connection to a remote ATCM Run Time System and 
 ...
 * visGetFirmware
 *
 * Retrieves the firmware version of the connected remote ATCMControl Run Time 
 * System. If the VisuComm library is not fully initialized, this function 
 * returns zero.
 *
 * return			Firmware version of connected ATCM RTS.
 *
 */
 ...
 * visNeedByteSwap
 *
 * This function returns TRUE if data from or to the connected remote ATCMControl
 ...
 * actual connected ATCMControl Run Time System. If the VisuComm library is not fully 
 ...
 * visError
 *
 * Determines an error text to a given ATCMControl Run Time System error number.
 *
 * I	uErrNo		Error number returned by a ATCM RTS function.
 *
 ...
 * connection to a ATCMControl Run Time System and gets its corresponding 
 * configuration.
 *
 * I	szAddr		TCP/IP address of the remote ATCM Run Time System.
 * I	uPort		Port number of the remote ATCM Run Time System.
 ...
 * visFinalize
 *
 * Closes any connection to a remote ATCM Run Time System and skips any 
 ...
 * version of the attached remote ATCM Run Time System. See the function
 ...
 * visGetValue
 *
 * Gets the values for the given variable list from the attached ATCMControl 
 ...
 * by the visGetAddress() function. (Addresses in the ATCMControl interpreter ares
 ...
 * visSetValue
 *
 * Writes the given value list into the attached ATCMControl Run Time System.
 *
 ...
 * must be provided always in the format of the attached remote ATCM RTS.)
 *
 ...
 * visRetainWrite
 *
 * This function advices the connected ATCMControl Run Time System to write the 
 ...
 * update configuration file to the attached ATCMControl Run Time System.
 *
 ...
 * visGetInstKey
 *
 * Reads the installation key from the attached ATCMControl Run Time System.
 *
 ...
 * visSetLicKey
 *
 * Writes a license key to the attached ATCMControl Run Time System.
 *
 ...
 * visGetSerialNo
 *
 * Reads the serial number of the attached ATCMControl Run Time System.
 *
 ...
 * visGetFeature
 *
 * Reads the available and licensed features of the attached ATCMControl Run Time 
 ...
 * visGetTargetType
 *
 * Reads the target type (i.e. "ATCMControl BuildingController" from the attached 
 * ATCMControl Run Time System.
 *
 ...
 * visSetLicEx
 *
 * Writes an extended license key to the attached ATCMControl Run Time System.
 *
