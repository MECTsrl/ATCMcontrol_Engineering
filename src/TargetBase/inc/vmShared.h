/* $Header: /4CReleased/V2.20.00/Target/4CWin/inc/vmShared.h 2     19.04.07 13:13 Ln $
 * ------------------------------------------------------------------------------
 *
 * =FILENAME			$Workfile: vmShared.h $
 *						 $Logfile: /4CReleased/V2.20.00/Target/4CWin/inc/vmShared.h $
 *
...
#define ERR_ERROR				0x0001u /* General error							*/
...
#define ERR_UNKNOWN_PRODUCT 	0x0223u /* Unknown ATCMControl product ID given.		*/
