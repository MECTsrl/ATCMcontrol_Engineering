...
@ECHO call %SRCPATH%\_V2.10.05\Setup.exe -ini "Uninstall.ini" -close -uni_all
      call %SRCPATH%\_V2.10.05\Setup.exe -ini "Uninstall.ini" -close -uni_all
...
echo call %SRCPATH%\_V2.10.05\Setup.exe -ini "Embedded.ini" -close -all -dir "%PROJECT_ROOT%"
     call %SRCPATH%\_V2.10.05\Setup.exe -ini "Embedded.ini" -close -all -dir "%PROJECT_ROOT%"
...
echo xcopy %SRCPATH%\SysgenV2\V2.10.05.%1\4Control\COM\*.* %PROJECT_ROOT%\COM\*.* /S /Y /Q /K /R /E
     xcopy %SRCPATH%\SysgenV2\V2.10.05.%1\4Control\COM\*.* %PROJECT_ROOT%\COM\*.* /S /Y /Q /K /R /E
if errorlevel 1 goto error

echo xcopy %SRCPATH%\SysgenV2\V2.10.05.%1\4Control\Pub\*.* %PROJECT_ROOT%\Pub\*.* /S /Y /Q /K /R /E
     xcopy %SRCPATH%\SysgenV2\V2.10.05.%1\4Control\Pub\*.* %PROJECT_ROOT%\Pub\*.* /S /Y /Q /K /R /E
if errorlevel 1 goto error

echo xcopy %SRCPATH%\SysgenV2\V2.10.05.%1\4Control\TargetBase\*.* %TARGET_BASE%\*.* /S /Y /Q /K /R /E
     xcopy %SRCPATH%\SysgenV2\V2.10.05.%1\4Control\TargetBase\*.* %TARGET_BASE%\*.* /S /Y /Q /K /R /E
if errorlevel 1 goto error
...
echo call %SSPATH%\ss get $/4CReleased/V2.10.05/TargetBase -R -I-y -Yln -GL%TARGET_BASE%
     call %SSPATH%\ss get $/4CReleased/V2.10.05/TargetBase -R -I-y -Yln -GL%TARGET_BASE%
if errorlevel 1 goto error
...
echo call %SSPATH%\ss get $/4CReleased/V2.10.05/Target/4CWin -R -I-y -Yln -GL%PROJECT_ROOT%\Target\4CWin
     call %SSPATH%\ss get $/4CReleased/V2.10.05/Target/4CWin -R -I-y -Yln -GL%PROJECT_ROOT%\Target\4CWin
if errorlevel 1 goto error
...
echo call %SSPATH%\ss get $/AOReleased/4CFC_V2.10.05 -R -I-y -Yln -GL%PROJECT_ROOT%\Target\4CFC
     call %SSPATH%\ss get $/AOReleased/4CFC_V2.10.05 -R -I-y -Yln -GL%PROJECT_ROOT%\Target\4CFC
if errorlevel 1 goto error
...
echo call %SSPATH%\ss get $/AOReleased/4CBC_V2.10.05 -R -I-y -Yln -GL%PROJECT_ROOT%\Target\4CBC
     call %SSPATH%\ss get $/AOReleased/4CBC_V2.10.05 -R -I-y -Yln -GL%PROJECT_ROOT%\Target\4CBC
if errorlevel 1 goto error
