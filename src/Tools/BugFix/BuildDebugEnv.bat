...
REM if not exist I:\fullgen.err goto error
REM if not exist I:\genall.log goto error
echo I: not available or incomplete build.
goto finish
...
REM echo copy control
REM xcopy /Q /C /R /S /Y %GENBASE%\Control\*.* %PROJECT_ROOT%\Control\*.*
