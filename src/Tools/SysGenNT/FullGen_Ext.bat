...
echo call GenKernel_Ext %LFG_BRANCH% %LFG_BUILD%
     call GenKernel_Ext %LFG_BRANCH% %LFG_BUILD%
...
echo call GenTarget_Ext 4CWin %FC_VERSION%.%LFG_KERN_BLD% %LFG_BRANCH% %LFG_BUILD%
     call GenTarget_Ext 4CWin %FC_VERSION%.%LFG_KERN_BLD% %LFG_BRANCH% %LFG_BUILD%
if errorlevel 1 goto error
