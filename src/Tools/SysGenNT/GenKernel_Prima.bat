...
echo perl ..\GenTools\make.pl Kernel_Prima
...
echo nmake -nologo -i -f Kernel_Prima.mak makemake "DEBUG=1" all 2>&1 | perl ..\GenTools\LogFile.pl Build.log
echo nmake -nologo -i -f Kernel_Prima.mak makemake "DEBUG=1" all 2>&1 | perl ..\GenTools\LogFile.pl Build.log          >> %LSG_LOGFILE%
     nmake -nologo -i -f Kernel_Prima.mak makemake "DEBUG=1" all 2>&1 | perl ..\GenTools\LogFile.pl Build.log  >> nul 2>> %LSG_LOGFILE%
if errorlevel 1 goto error
...
echo nmake -nologo -i -f TargetBase_Prima.mak makemake "DEBUG=1" all 2>&1 | perl ..\GenTools\LogFile.pl Build.log
echo nmake -nologo -i -f TargetBase_Prima.mak makemake "DEBUG=1" all 2>&1 | perl ..\GenTools\LogFile.pl Build.log          >> %LSG_LOGFILE%
     nmake -nologo -i -f TargetBase_Prima.mak makemake "DEBUG=1" all 2>&1 | perl ..\GenTools\LogFile.pl Build.log  >> nul 2>> %LSG_LOGFILE%
if errorlevel 1 goto error
